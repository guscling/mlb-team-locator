#Name: Gus Clingroth #ID: asclingr
#READ ME: This program is designed to, given a series of user arguments, provide a list of cities that would be viable for an MLB expansion team
#With an MLB expansion confirmed to be coming within the next few years, there is a need to locate the most viable cities.
    #This program provides a tool to broadly locate ideal expansion sites based on population, climate, and proximity to existing markets.
    #This can help narrow down which cities may be viable for an MLB team.
...
#The program will not run properly if these five arguments are not given in this order. If fewer than 5 arguments are provided, the script will prompt the user to input the requires arguments in the console.
#Example input: 90 2000000 90 45 6

#The data necessary to run this program is zipped with this Python file.
#The program should run correctly if it is not moved from the folder it is zipped in. The directories should be structured as follows:
#Zipped_Folder/
    #finalProject.py
    #originalData/
...
###Information about the data:
    #The CSA boundaries are from 2023 and come from the US Census Bureau
    #The CSA population table is from 2024 and comes from the US Census Bureau
    #The maximum temperature, minimum temperature, and precipitation rasters all come from WorldClim.
